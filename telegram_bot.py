...
async def menu_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if text == "💳 Pay with Flutterwave":
        ...
        await update.message.reply_text("💳 Click below to pay:", reply_markup=InlineKeyboardMarkup(keyboard))
        ...
        await update.message.reply_text(
            "🏦 Bank Transfer:\n\n"
            "Bank: Opay\n"
            "Name: Abdulsalam Sulaiman Attah\n"
            "Account: 9039475752\n\n"
